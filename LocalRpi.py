...
model_weights_path = Path('path/to/your/yolov5/weights/best.pt')  # Update this path
model = torch.hub.load('ultralytics/yolov5', 'custom', path=str(model_weights_path), force_reload=True)
